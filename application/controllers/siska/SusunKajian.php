...
class SusunKajian extends CI_Controller {
    ...
    $data['pegawai']=$this->Madmin->tampil_data('pegawai');
  	$data['kajian']=$this->Madmin->tampil_susun_field('kajian','id_jenis',1);
  	$data['jumkajian']=$this->Madmin->tampil_susun_num('kajian','id_jenis',1);
  	$data['jurnal']=$this->Madmin->tampil_susun_field('kajian','id_jenis',2);
  	$data['jumjurnal']=$this->Madmin->tampil_susun_num('kajian','id_jenis',2);
  	$data['PB']=$this->Madmin->tampil_susun_field('kajian','id_jenis',3);
  	$data['jumPB']=$this->Madmin->tampil_susun_num('kajian','id_jenis',3);
  	$data['PN']=$this->Madmin->tampil_susun_field('kajian','id_jenis',4);
  	$data['jumPN']=$this->Madmin->tampil_susun_num('kajian','id_jenis',4);
		$data['js']=$this->js("pegawai");
		//$data['lihat']=$this->Madmin->tampil_data_field('user','jenis_user',1);
    $data['nav']	="SusunKajian";
    ...
    $data['aktif']="susun";
    $data['id_user']=$this->session->userdata('jenis');
  ...
  function detail_kajian($id,$jenis){
    ...
    $this->load->view('admin/nav', $data);
    $this->load->view('admin/sidebar', $data);
    $this->load->view('admin/pages/penyusunan_detail', $data);
    $this->load->view('admin/foot', $data);
  }
