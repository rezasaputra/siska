            ...
            <div class="col-md-9">
                <div class="page-content">
                    <center><h2 class="margin-bottom-30">Sebaran Analis Kebijakan</h2></center>
                    <img src="<?=base_url()?>assets/frontend/upload/sebaran_ak.JPG" width="100%" height="auto">
                    <hr/>
                    <!--hr line-->
