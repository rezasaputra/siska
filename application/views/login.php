    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="<?php echo base_url()?>">
                <img width="70px" src="<?php echo base_url()?>assets/global/img/Logo v4.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo base_url()?>Siskalogin/masuk" method="post">
                <h3 class="form-title font-green">Siska Administrator</h3>
        ...
        <div class="copyright">
            <small>Copyright ©2018
                <a target="_blank" href="http://pusaka.go.id"><strong>LAN</strong></a>
            </small>
         </div>
        <!--[if lt IE 9]>
