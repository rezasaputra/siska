          ...
          <div class="col-sm-8">
            ...
            <div class="card">
              <div class="card-header header-elements-inline">
                <h5 class="card-title">Daftar User Deputi</h5>
            ...
            <div class="card">
              <div class="card-header header-elements-inline">
                <h5 class="card-title">Tambah User Deputi  </h5>
                <div class="header-elements">
                  <div class="list-icons">
                            <a class="list-icons-item" data-action="collapse"></a>
                            <a class="list-icons-item" data-action="reload"></a>
              ...
              <div class="card-body">
                <form action="<?=base_url()?>siska/U_deputi/tambah_user/user/4" method="POST" enctype="multipart/form-data">
